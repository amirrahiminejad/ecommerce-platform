...
public class AdPageController {
    ...
    public String showEditForm(@PathVariable Long id, Model model) {
        try {
            ...
            // دریافت تصاویر آگهی
            java.util.List<com.webrayan.bazaar.core.common.entity.Image> existingImages = new java.util.ArrayList<>();
            if (ad.getImages() != null && !ad.getImages().isEmpty()) {
                for (com.webrayan.bazaar.modules.ads.entity.AdImage adImage : ad.getImages()) {
