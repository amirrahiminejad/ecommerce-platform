...
public interface AdService {
     ...
     */
    long countByUser(com.webrayan.store.modules.acl.entity.User user);
    
    /**
     * شمارش آگهی‌های فعال کاربر
     */
    long countActiveAdsByUser(com.webrayan.store.modules.acl.entity.User user);
    
    /**
     * دریافت آگهی‌های کاربر
     */
    Page<Ad> getAdsByUser(com.webrayan.store.modules.acl.entity.User user, Pageable pageable);
    
    /**
     * دریافت آگهی‌های کاربر بر اساس وضعیت
     */
    Page<Ad> getAdsByUserAndStatus(com.webrayan.store.modules.acl.entity.User user, String status, Pageable pageable);

    /**
     * شمارش آگهی‌های کاربر بر اساس وضعیت
     */
    long countByUserAndStatus(com.webrayan.store.modules.acl.entity.User user, com.webrayan.store.modules.ads.enums.AdStatus status);
