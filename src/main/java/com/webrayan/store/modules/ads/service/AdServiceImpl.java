...
public class AdServiceImpl implements AdService {
    ...
    protected void saveAdImage(Ad ad, org.springframework.web.multipart.MultipartFile imageFile) throws Exception {
        ...
        com.webrayan.store.core.common.entity.Image image = new com.webrayan.store.core.common.entity.Image();
        ...
        com.webrayan.store.core.common.entity.Image savedImage = imageMetadataRepository.save(image);
        
        // ایجاد رابطه AdImage
        com.webrayan.store.modules.ads.entity.AdImage adImage = new com.webrayan.store.modules.ads.entity.AdImage();
        adImage.setAd(ad);
    ...
    public Ad updateAdWithImages(Long id, AdRequestDto adRequest, org.springframework.web.multipart.MultipartFile[] images, java.util.List<Long> keepImages) {
        ...
        if (updatedAd.getImages() != null) {
            java.util.List<com.webrayan.store.modules.ads.entity.AdImage> imagesToRemove = new java.util.ArrayList<>();
            for (com.webrayan.store.modules.ads.entity.AdImage adImage : updatedAd.getImages()) {
            ...
            for (com.webrayan.store.modules.ads.entity.AdImage adImage : imagesToRemove) {
                try {
                    // حذف فایل از دیسک
