...
import com.webrayan.store.modules.acl.entity.Permission;
import com.webrayan.store.modules.acl.entity.Role;
import com.webrayan.store.modules.acl.entity.User;
import com.webrayan.store.modules.acl.repository.PermissionRepository;
...
import com.webrayan.store.modules.acl.service.RoleService;
...
public class SecurityDataInitializer {
    ...
    private void initializeDefaultAdminUser() {
        ...
        if (!userRepository.existsByUsername("admin")) {
            ...
            adminUser.setEmail("admin@iran-store.com");
