...
public interface AdService {
     ...
     */
    long countByUser(com.webrayan.commerce.modules.acl.entity.User user);
    
    /**
     * شمارش آگهی‌های فعال کاربر
     */
    long countActiveAdsByUser(com.webrayan.commerce.modules.acl.entity.User user);
    
    /**
     * دریافت آگهی‌های کاربر
     */
    Page<Ad> getAdsByUser(com.webrayan.commerce.modules.acl.entity.User user, Pageable pageable);
    
    /**
     * دریافت آگهی‌های کاربر بر اساس وضعیت
     */
    Page<Ad> getAdsByUserAndStatus(com.webrayan.commerce.modules.acl.entity.User user, String status, Pageable pageable);

    /**
     * شمارش آگهی‌های کاربر بر اساس وضعیت
     */
    long countByUserAndStatus(com.webrayan.commerce.modules.acl.entity.User user, com.webrayan.commerce.modules.ads.enums.AdStatus status);
